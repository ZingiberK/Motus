...
# Flow-Matching scheduler (training)
...
class Motus(nn.Module):
    ...
    # ------------------------------------------------------------------ Flow-SDE RL
    # Phase 2 (see Motus/MOTUS_PLAN.md): video branch = supervised FM on observed
    # futures; action branch = PPO on Flow-SDE log-probs (isolated gradients).
